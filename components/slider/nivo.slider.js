...
var componentName = "slider";

function _reverse(data) {
  return [].reverse.call(data, data);
}

var NivoSlider = ComponentClass.extend({
    ...
    var nivoRun  = this._nivoRun = function (slider, kids, settings, nudge) {
      ...
      if (currentEffect === 'sliceDown' || currentEffect === 'sliceDownRight' || currentEffect === 'sliceDownLeft') {
        ...
        if (currentEffect === 'sliceDownLeft') {
          slices = _reverse($('.nivo-slice', slider));
        }
        ...
        if (currentEffect === 'boxRainReverse' || currentEffect === 'boxRainGrowReverse') {
          boxes = _reverse($('.nivo-box', slider));
        }
        boxes.each(function () {
...
// Register plugin.
createPlugin(componentName, NivoSlider);

UI.ready(function slider(context) {
  var $slider = $('[data-slider]', context);
  // auto initialize component via data-api.
  $slider[componentName]();
}, NivoSlider.getInstanceName(componentName));

module.exports = NivoSlider;
